...
#include "stanExports_rubin_full.h"

RCPP_MODULE(stan_fit4rubin_full_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_rubin_full")
