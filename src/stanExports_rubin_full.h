...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(32, 2, "restart", "model_rubin_full");
    reader.add_event(183, 151, "end", "model_rubin_full");
    return reader;
}
...
public:
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(prior_increment_vec(prior_sigma_fam, sigma_y_k, prior_sigma_val, pstream__));
