...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(20, 2, "restart", "model_rubin_full");
    reader.add_event(157, 137, "end", "model_rubin_full");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "prior_sigma_fam", "int", context__.to_vec());
            prior_sigma_fam = int(0);
            vals_i__ = context__.vals_i("prior_sigma_fam");
            pos__ = 0;
            prior_sigma_fam = vals_i__[pos__++];
            current_statement_begin__ = 49;
            validate_non_negative_index("prior_sigma_val", "3", 3);
            context__.validate_dims("data initialization", "prior_sigma_val", "vector_d", context__.to_vec(3));
            prior_sigma_val = Eigen::Matrix<double, Eigen::Dynamic, 1>(3);
            vals_r__ = context__.vals_r("prior_sigma_val");
            pos__ = 0;
            size_t prior_sigma_val_j_1_max__ = 3;
            for (size_t j_1__ = 0; j_1__ < prior_sigma_val_j_1_max__; ++j_1__) {
                prior_sigma_val(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(pooling_type, 0))) {
                ...
                lp_accum__.add(normal_log<propto__>(y, add(add(stan::model::rvalue(baseline_k, stan::model::cons_list(stan::model::index_multi(site), stan::model::nil_index_list()), "baseline_k"), elt_multiply(stan::model::rvalue(theta_k, stan::model::cons_list(stan::model::index_multi(site), stan::model::nil_index_list()), "theta_k"), treatment)), fe), stan::model::rvalue(sigma_y_k, stan::model::cons_list(stan::model::index_multi(site), stan::model::nil_index_list()), "sigma_y_k")));
            } else if (as_bool(logical_eq(pooling_type, 1))) {
                ...
                lp_accum__.add(normal_log<propto__>(y, add(add(stan::model::rvalue(baseline_k, stan::model::cons_list(stan::model::index_multi(site), stan::model::nil_index_list()), "baseline_k"), multiply(get_base1(mu, 1, "mu", 1), treatment)), fe), stan::model::rvalue(sigma_y_k, stan::model::cons_list(stan::model::index_multi(site), stan::model::nil_index_list()), "sigma_y_k")));
            }
            current_statement_begin__ = 133;
            lp_accum__.add(vecprior_lpdf<propto__>(sigma_y_k, prior_sigma_fam, prior_sigma_val, pstream__));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
