...
static constexpr std::array<const char*, 138> locations_array__ =
  ...
  " (in 'string', line 66, column 2 to column 48)",
  " (in 'string', line 67, column 2 to column 35)",
  " (in 'string', line 68, column 2 to column 58)",
  " (in 'string', line 69, column 2 to column 45)",
  ...
  " (in 'string', line 128, column 2 to column 31)",
  ...
  " (in 'string', line 53, column 2 to column 48)",
  ...
  " (in 'string', line 57, column 8 to column 14)",
  " (in 'string', line 57, column 2 to column 28)",
  " (in 'string', line 58, column 8 to column 14)",
  " (in 'string', line 58, column 2 to column 36)",
  " (in 'string', line 61, column 2 to column 43)",
  " (in 'string', line 62, column 2 to column 51)",
  " (in 'string', line 66, column 8 to column 29)",
  " (in 'string', line 67, column 8 to column 25)",
  " (in 'string', line 68, column 8 to column 29)",
  " (in 'string', line 69, column 8 to column 25)",
...
private:
  ...
  int prior_sigma_fam;
  Eigen::Matrix<double,-1,1> prior_sigma_val_data__;
  int N_test;
  int K_test;
  ...
  Eigen::Map<Eigen::Matrix<double,-1,1>> prior_sigma_val{nullptr, 0};
  Eigen::Map<Eigen::Matrix<double,-1,-1>> X_test{nullptr, 0, 0};
public:
  ~model_rubin_full() {}
  model_rubin_full(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_rubin_full_namespace::model_rubin_full";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
    ...
    try {
      ...
      context__.validate_dims("data initialization", "prior_sigma_fam",
        "int", std::vector<size_t>{});
      ...
      context__.validate_dims("data initialization", "prior_sigma_val",
        "double", std::vector<size_t>{static_cast<size_t>(3)});
      prior_sigma_val_data__ = Eigen::Matrix<double,-1,1>::Constant(3,
                                 std::numeric_limits<double>::quiet_NaN());
      new (&prior_sigma_val)
        Eigen::Map<Eigen::Matrix<double,-1,1>>(prior_sigma_val_data__.data(),
        3);
      {
        std::vector<local_scalar_t__> prior_sigma_val_flat__;
        current_statement__ = 88;
        prior_sigma_val_flat__ = context__.vals_r("prior_sigma_val");
        current_statement__ = 88;
        pos__ = 1;
        current_statement__ = 88;
        for (int sym1__ = 1; sym1__ <= 3; ++sym1__) {
          current_statement__ = 88;
          stan::model::assign(prior_sigma_val, prior_sigma_val_flat__[(pos__
            - 1)], "assigning variable prior_sigma_val",
            stan::model::index_uni(sym1__));
          current_statement__ = 88;
          pos__ = (pos__ + 1);
        }
      ...
      test_sigma_y_k = std::vector<double>(K_test,
                         std::numeric_limits<double>::quiet_NaN());
      current_statement__ = 103;
      test_sigma_y_k = context__.vals_r("test_sigma_y_k");
    ...
    num_params_r__ = mu_baseline_1dim__ + mu_1dim__ + tau_baseline_1dim__ +
      tau_1dim__ + K_pooled + K_bsl_pooled + Nc + K;
  }
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_rubin_full_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      }
      {
        ...
        lp_accum__.add(vecprior_lpdf<propto__>(sigma_y_k, prior_sigma_fam,
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_rubin_full_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    names__ = std::vector<std::string>{"mu_baseline", "mu", "tau_baseline",
                "tau", "eta", "eta_baseline", "beta", "sigma_y_k"};
    if (emit_transformed_parameters__) {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"mu_baseline\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(mu_baseline_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(mu_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"tau_baseline\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(tau_baseline_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"tau\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(tau_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"parameters\"},{\"name\":\"eta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K_pooled) + "},\"block\":\"parameters\"},{\"name\":\"eta_baseline\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K_bsl_pooled) + "},\"block\":\"parameters\"},{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(Nc) + "},\"block\":\"parameters\"},{\"name\":\"sigma_y_k\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"parameters\"},{\"name\":\"theta_k\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K_pooled) + "},\"block\":\"transformed_parameters\"},{\"name\":\"baseline_k\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(K) + "},\"block\":\"transformed_parameters\"},{\"name\":\"logpd\",\"type\":{\"name\":\"array\",\"length\":" + std::to_string(logpd_1dim__) + ",\"element_type\":{\"name\":\"real\"}},\"block\":\"generated_quantities\"},{\"name\":\"fe_test\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(N_test) + "},\"block\":\"generated_quantities\"}]");
  }
